...
function ajaxget(id,url,type){
	...
	setTimeout(function(){
		$.ajax({
			...
			data: "urllist="+encodeURIComponent(url)+"&autopcbox="+autopcbox+"&autosearchuser="+autosearchuser+"&nick="+encodeURIComponent(nick)+"&pass="+encodeURIComponent(pass)+'&captcha='+captcha+"&"+param,
